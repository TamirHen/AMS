...
public class Minor extends Employee {
	private int managerName;
	private String role;

	// Constructor:
	public Minor(int id, String firstName, String lastName, int age, Department department, float salary,
			int managerName, String role) {
